...
template<class Key>
class Linear : public Dispersion_Function<Key> {
private:
    unsigned datasize_;
public:
  Linear() {}
...
template<class Key>
class Quadratic : public Dispersion_Function<Key> {
private:
    unsigned datasize_;
public:
  Linear() {}
...
template<class Key>
class Double_Dispersion : public Dispersion_Function<Key> {
private:
    unsigned datasize_;
public:
  Double_Dispersion() {}
...
template<class Key>
class Redispersion : public Dispersion_Function<Key> {
private:
    unsigned datasize_;
public:
  Double_Dispersion() {}
