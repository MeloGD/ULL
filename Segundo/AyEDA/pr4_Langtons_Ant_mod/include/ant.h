...
// MOD
// LAS SIGUIENTES CLASES HORMIGAS SE MOVERAN 2 Y 3 POSICIONES RESPECTIVAMENTE

class Modified_Ant_2 : public Ant {
private:

public:
  Modified_Ant_2();
  Modified_Ant_2(World &mundo, int i, int j, string direction);
  ~Modified_Ant_2();
...
class Modified_Ant_3 : public Ant {
private:

public:
  Modified_Ant_3();
  Modified_Ant_3(World &mundo, int i, int j, string direction);
  ~Modified_Ant_3();
